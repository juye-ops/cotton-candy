...
-- 2023년 08월 02일 (수) 오후 09시 22분 57초
...
CREATE TABLE IF NOT EXISTS `cotton_db`.`framework` (
  ...
  `type` ENUM("framework", "dbms") NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
START TRANSACTION;
USE `cotton_db`;
INSERT INTO `cotton_db`.`framework` (`id`, `name`, `type`) VALUES (DEFAULT, 'python', DEFAULT);
INSERT INTO `cotton_db`.`framework` (`id`, `name`, `type`) VALUES (DEFAULT, 'node', DEFAULT);
INSERT INTO `cotton_db`.`framework` (`id`, `name`, `type`) VALUES (DEFAULT, 'mysql', DEFAULT);
